...
public static void main(String[] args) {
	...
	ilist.sort(Comparator.reverseOrder());	// reverse: 역순 
											//Comparator 인터페이스의 static 멧드
	...
	System.out.println("내림 차순 sort(DESCending)  : " + slist);
...
//  Member 객체의 sort : 비교가능한 값으로 필드 중 하나를 선택해서 비교자(Comparator) 구현체 만듭니다.
	...
	mlist.sort(new MemberAgeAescending());
...
//User는 비교할 수 있는 타입 : Comparable 구현체
	ulist.sort(null);
	System.out.println("user sort(ACS) :" + ulist);
	...
	System.out.println("user sort(name ACS) :" + ulist);
