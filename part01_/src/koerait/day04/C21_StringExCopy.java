...
public static void main(String[] args) {
	 ...
	 *  		ㄴ '@' 의 indexof 를 구해서 그 뒤부터 끝까지(lenght()-1) substring 추출한 문자열을 equals 비교
	 *  
	...
	email = sc.nextLine();		//키보드 입력을 문자로 처리합니다.
	email.indexOf('@');
	idx = email.indexOf('@');
	if(idx>-1) {
	...
	//입력한 email이 처리조건 1,2,3,4,5 에 해당하지 않으면 메세지 출력하고 isValid 변수를 false로 합니다. -> isValid 출력
	}
