...
public class MathProblem {
	//인스턴스 필드: static이 아닌 형식. 객체가 생성될때마다 다른값을 갖는다.
private int n1;
private int n2;
private char op;	//+,-,*,/
private boolean isCorrect;	// 사용자 입력한 답 맞추었는지 답이 정답인지.....여부
// isCorrect 필드대신에 ans필드 추가해서 사용자가 입력한 답 저장할 수도 있습니다.
 ...
 *  스턴스 메소드는 인스턴스 필드값과 상관있게 동작하는 메소드
 */
...
public void makeProb() { // 사칙연산 종류별로 적절한 난수 생성하기->문제를 만들어 줍니다.
	...
	case '+':
		...
		break;
	case '-':
		max1=99;max2=49;min1=50;min2=11;	//n1운 50~99 , n2는 11~49 : n1<n2 이 되도록.
		break;
	case '*':
		max1=77;max2=29;min1=11;min2=11;	//n1은 11~77, n2는 11~29  : n1>n2 곱셈과정을 고려 n2를 적게
		break;
	case '/':
		max1=99;max2=29;min1=41;min2=11;	//n1은 41~99, n2는 11~29 : n1>n2 나눗셈 과정을 고려 n1을 더 크게
		break;
