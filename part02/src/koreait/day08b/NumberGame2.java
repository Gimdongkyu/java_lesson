...
public static void main(String[] args) {
	...
	do {
		//여기서부터
			...
			if(i==max) {
				System.out.println("너 휴면 입력한 내용 : " + Arrays.toString(triallst));
			...
			// 위의 게임결과(GameValue)를 history배열에 저장
			history[k] = temp;		//temp는 GameValue 객체의 찹조값(주소)
			k++; // 다음 인덱스 값, 카운트 역할
			
			System.out.println("게임을 계속하시겠습니니까? 계속하려면 0 입력 >>>");
	}while(sc.nextInt()==(0));
