...
public class C47_MemberTest {
	...
	public static void main(String[] args) {
		...
		list.add(new Member("모모",27)); // 새로운 객체 상성하고 참조값을 리스트에 추가
		...
		System.out.println("2.list의 요소 중 참조 객체 age 필드 값이 25이하 인것만 출력해보기."); //for
		...
		System.out.println("3. '나나'는 몇번 인덱스에서 참조하고 있는 객체인가 있는가?");
			for(int i = 0;i<list.size();i++) {
	...
	//					 indexOf는 String, 기본형 래퍼클래스만 추가적인 기능 구현없이 사용합니다.
		...
		// indexOf 메소드는 제너릭타입이 String, 기본형 래퍼 클래스만 추가적인 기능 구현없이 사용합니다.
